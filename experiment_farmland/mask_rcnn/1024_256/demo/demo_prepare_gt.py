...
def imshow_gt_bboxes(img,
    ...
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        poly = [[bbox_int[0], bbox_int[1]], [bbox_int[0], bbox_int[1]+bbox_int[3]],
                [bbox_int[0]+bbox_int[2], bbox_int[1]+bbox_int[3]], [bbox_int[0]+bbox_int[2], bbox_int[1]]]
